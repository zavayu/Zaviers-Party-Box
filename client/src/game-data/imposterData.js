// Game categories and secret words for Imposter
...
export const GAME_DATA = {
  Animals: {
    ...
    words: [
      ...
      'Otter', 'Seal', 'Walrus', 'Polar Bear', 'Platypus', 'Hedgehog',
      'Raccoon', 'Squirrel', 'Rabbit', 'Hamster', 'Guinea Pig', 'Ferret',
      'Bat', 'Beaver', 'Porcupine', 'Skunk', 'Badger', 'Weasel',
      'Parrot', 'Flamingo', 'Peacock', 'Pelican', 'Hummingbird', 'Toucan',
      'Stingray', 'Starfish', 'Crab', 'Lobster', 'Shrimp', 'Clam',
      'Bee', 'Ant', 'Ladybug', 'Grasshopper', 'Mantis', 'Beetle'
    ]
  },
  ...
  Movies: {
    ...
    words: [
      ...
      'Dune', 'Top Gun: Maverick', 'Spider-Man: No Way Home',
      'Everything Everywhere All at Once', 'Oppenheimer', 'Barbie',
      'Guardians of the Galaxy', 'Black Widow', 'Shang-Chi',
      'Eternals', 'Encanto', 'Lightyear'
    ]
  },
  ...
  Video_Games: {
    emoji: '🎮',
    words: [
      'Minecraft', 'Grand Theft Auto V', 'Tetris', 'Wii Sports', 'PUBG',
      'Mario Kart', 'Red Dead Redemption 2', 'Terraria', 'Pac-Man',
      'Super Mario', 'Zelda', 'Halo', 'Call of Duty', 'Fortnite', 'League of Legends',
      'Overwatch', 'Apex Legends', 'Valorant', 'Counter-Strike', 'Elden Ring',
      'Dark Souls', 'Genshin Impact', 'Stardew Valley', 'Animal Crossing', 'Pokemon',
      'Final Fantasy', 'Kingdom Hearts', 'Persona', 'Street Fighter', 'Tekken', 'Mortal Kombat',
      'Smash Bros', 'Rocket League', 'FIFA', 'NBA 2K', 'Madden', 'The Sims', 'Civilization VI',
      'Portal', 'Half-Life', 'Skyrim'
    ]
  },
  ...
  Celebrities: {
    emoji: '⭐',
    words: [
      'Taylor Swift', 'Drake', 'Beyoncé', 'Ariana Grande', 'The Weeknd',
      'Leonardo DiCaprio', 'Brad Pitt', 'Tom Cruise', 'Jennifer Lawrence', 'Scarlett Johansson',
      'Dwayne Johnson', 'Ryan Reynolds', 'Chris Hemsworth', 'Zendaya', 'Timothée Chalamet',
      'LeBron James', 'Cristiano Ronaldo', 'Lionel Messi', 'Tom Brady', 'Serena Williams',
      'Elon Musk', 'Kim Kardashian', 'Kylie Jenner', 'Justin Bieber', 'Selena Gomez',
      'Billie Eilish', 'Bad Bunny', 'Post Malone', 'Rihanna', 'Lady Gaga',
      'Ed Sheeran', 'Adele', 'Bruno Mars', 'Harry Styles', 'Dua Lipa',
      'Eminem', 'Kanye West', 'Jay-Z', 'Snoop Dogg', 'Cardi B',
      'Will Smith', 'Johnny Depp', 'Robert Downey Jr', 'Morgan Freeman', 'Denzel Washington'
    ]
  },
  ...
  Superheroes: {
    ...
    words: [
      ...
      'Deadpool', 'Wolverine', 'Cyborg', 'Daredevil', 'Punisher',
  ...
  Body: {
    emoji: '🫀',
    words: [
      'Heart', 'Brain', 'Lungs', 'Liver', 'Kidneys', 'Stomach',
      'Pancreas', 'Spleen', 'Gallbladder', 'Bladder', 'Intestines',
      'Esophagus', 'Thyroid', 'Skin', 'Eyes', 'Ears', 'Tongue',
      'Appendix', 'Colon', 'Rectum', 'Prostate',
      'Uterus', 'Ovaries', 'Testes', 'Thymus', 'Adrenal Glands',
      'Pituitary Gland', 'Trachea', 'Larynx', 'Pharynx',
      'Skull', 'Femur', 'Tibia', 'Fibula', 'Humerus', 'Radius',
      'Ulna', 'Ribs', 'Spine', 'Vertebrae', 'Pelvis', 'Clavicle',
      'Scapula', 'Sternum', 'Patella', 'Mandible', 'Maxilla', 'Metacarpals',
      'Metatarsals', 'Phalanges', 'Carpals', 'Tarsals', 'Sacrum', 'Coccyx',
      'Biceps', 'Triceps', 'Deltoids', 'Pectorals', 'Abdominals', 'Quadriceps',
      'Hamstrings', 'Calves', 'Glutes', 'Trapezius', 'Latissimus Dorsi', 'Obliques',
      'Hip Flexors', 'Rotator Cuff', 'Gastrocnemius', 'Soleus', 'Tibialis Anterior',
      'Serratus Anterior', 'Rhomboids', 'Adductors', 'Abductors'
    ]
  },
